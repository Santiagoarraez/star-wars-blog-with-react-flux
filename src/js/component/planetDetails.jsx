        ...
        <div className="h-100">
            <div className="container text-center">
                <div className="text-center fs-4 d-flex justify-content-between border-bottom border-4 border-danger">
                    <img src={planeticon} className="tarjeta" alt="..."></img>
                    <span className="w-50">
                ...
                <div className="d-flex justify-content-between mt-4">
                    <div className="text-center rojo">
                        <h5>NAME</h5>
                ...
                <button type="button" className="btn btn-outline-danger fs-3" onClick={() => {navigate("/")}}>Go back!</button>
            </div>
        </div>
    )
}
